...
\cventry{A Pretty Good CS School}{}
...
\regtext{Most APIs Crammed into a Single Web Application}, Some Hackathon
\\ \vspace{0.5em}
\regtext{Random Sponsor Prize}, Some Other Hackathon
\\ \vspace{0.5em}
\regtext{Registered User}, CodeForces
\\ \vspace{0.5em}
\regtext{Worked On Some Practice Problems}, USA Computing Olympiad
\\ \vspace{0.5em}
\regtext{Member}, Random Honor Societies that Fill up Resumes
...
\regtext{Organizer}, My School's Hackathon That's Way Better Than Yours
\\\vspace{0.5em}
\regtext{President}, Some Business Club to Network With People That'll Invest in My Company
\\\vspace{0.5em}
\regtext{Teaching Assistant}, Some Class Where I Kinda Just Debug Code
...
\cventry{My Own Super Awesome Startup}{Right Now}
{Foudner and CEO}
{\begin{tightemize}
...
\cventry{Some Decent Startup}{The Past}
{Something}
